...
<div class="row g-3 h-100">
  <div class="col-12 d-flex flex-column h-100" style="min-height: 0;">
    ...
    <div class="d-flex align-items-center justify-content-end flex-wrap gap-2 mb-2">
      ...
      <div class="d-flex align-items-center gap-2">
        <button class="btn btn-outline-secondary btn-sm" on:click={expandAllTools} aria-label="Expand all tool details" title="Expand all"><i class="bi bi-arrows-angle-expand"></i></button>
        <button class="btn btn-outline-secondary btn-sm" on:click={collapseAllTools} aria-label="Collapse all tool details" title="Collapse all"><i class="bi bi-arrows-angle-contract"></i></button>
      </div>
    </div>
