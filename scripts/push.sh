...
usage() {
    ...
    echo ""
    echo "Components:"
    echo "  server      Push the API server image"
    echo "  operator    Push the operator service image"
    echo "  host        Push the host agent image"
    ...
    echo "  $0 server operator      Push only server and operator"
